...
from utils import BaseEnumOptions, ClassEnumOptions, MethodMap, to_numpy
...
def estimate_range_line_search(W, quant, num_candidates=None):
    if num_candidates is None:
        est_fp = MSE_Estimator(quantizer=quant)
    else:
        est_fp = MSE_Estimator(quantizer=quant, num_candidates=num_candidates)
